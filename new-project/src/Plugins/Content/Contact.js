const Contact = () => {
    return (
        <div className=" pl-64 m-0">
        <section className=" bg-slate-800 py-20 lg:py-[200px] overflow-hidden relative z-10 text-gray-100">
          <div className="container">
            <div className="flex flex-wrap -mx-4 lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  <span className="block ml-0 mb-4 text-[20px] font-semibold text-primary">
                    Contact Us
                  </span>
                  ...
                  United Coders is a student group from the University of Queensland, composed of tech enthusiasts passionate about coding and development. We welcome connecting with you, sharing knowledge, and exploring collaboration opportunities. Whether you are a student, educator, industry expert, or anyone with an interest in technology, we are open to interacting with you.
                  </p>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      St Lucia Campus, The University of Queensland, Brisbane, Queensland, 4072 Australia
                      </p>
                    </div>
                  </div>
                  <div className="mb-8 flex w-full max-w-[370px]">
